			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="<?=base_url()?>assets/img/logo_mitratel.png" style="width: 250px;" alt="Klorofil Logo"></div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading" style="text-align: center; border: 20px;"><b>PT DAYA MITRA TELEKOMUNIKASI</b></h1>
						</div>
						</div>
					</div>
