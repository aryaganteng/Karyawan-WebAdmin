...
class Karyawan extends CI_Controller {
	...
	public function simpan_karyawan()
	{
		...
		$this->form_validation->set_rules('nik_tg', 'Nik TG', 'trim|required',
		array('required' => 'Nik TG harus diisi'));
		...
		// $this->form_validation->set_rules('no_aset', 'No_aset', 'trim|required',
		// // array('required' => 'No Aset harus diisi'));
		...
		if ($this->form_validation->run() == TRUE ) 
		{
			...
			redirect(base_url('index.php/newkar'),'refresh');
		}
		else{
